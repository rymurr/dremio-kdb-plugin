...
public final class KdbSortRule<S extends Sort> extends RelOptRule {
    public static final KdbSortRule PHYSICAL_INSTANCE = new KdbSortRule(SortPrel.class, Prel.PHYSICAL, "KdbSortPhysicalPrule");

    private KdbSortRule(Class<S> sortPrelClass, Convention physical, String kdbSortPhysicalPrule) {
        super(RelOptHelper.some(sortPrelClass, RelOptHelper.any(ExchangePrel.class, KdbIntermediatePrel.class)), kdbSortPhysicalPrule);
    }
